...
//        Entities.ForEach((ref LocalTransform localTransform, in PlayerMoveData moveData, in PlayerStatusData statusData) =>
//        {
//            float3 movement = new float3(moveData.Move.x, 0, moveData.Move.y) * deltaTime * statusData.MoveSpeed;
